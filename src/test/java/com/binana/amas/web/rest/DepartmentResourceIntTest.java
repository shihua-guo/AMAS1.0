...
public class DepartmentResourceIntTest {
    ...
    private static final String DEFAULT_DEPT_INTRODUTION = "AAAAAAAAAA";
    private static final String UPDATED_DEPT_INTRODUTION = "BBBBBBBBBB";

    private static final byte[] DEFAULT_DEPT_IMAGE = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_DEPT_IMAGE = TestUtil.createByteArray(2, "1");
    private static final String DEFAULT_DEPT_IMAGE_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_DEPT_IMAGE_CONTENT_TYPE = "image/png";
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department()
                ...
                .deptIntrodution(DEFAULT_DEPT_INTRODUTION)
                .deptImage(DEFAULT_DEPT_IMAGE)
                .deptImageContentType(DEFAULT_DEPT_IMAGE_CONTENT_TYPE);
        return department;
    }
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getDeptIntrodution()).isEqualTo(DEFAULT_DEPT_INTRODUTION);
        assertThat(testDepartment.getDeptImage()).isEqualTo(DEFAULT_DEPT_IMAGE);
        assertThat(testDepartment.getDeptImageContentType()).isEqualTo(DEFAULT_DEPT_IMAGE_CONTENT_TYPE);
    ...
    public void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].deptIntrodution").value(hasItem(DEFAULT_DEPT_INTRODUTION.toString())))
            .andExpect(jsonPath("$.[*].deptImageContentType").value(hasItem(DEFAULT_DEPT_IMAGE_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].deptImage").value(hasItem(Base64Utils.encodeToString(DEFAULT_DEPT_IMAGE))));
    }
    ...
    public void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments/{id}", department.getId()))
            ...
            .andExpect(jsonPath("$.deptIntrodution").value(DEFAULT_DEPT_INTRODUTION.toString()))
            .andExpect(jsonPath("$.deptImageContentType").value(DEFAULT_DEPT_IMAGE_CONTENT_TYPE))
            .andExpect(jsonPath("$.deptImage").value(Base64Utils.encodeToString(DEFAULT_DEPT_IMAGE)));
    }
    ...
    public void updateDepartment() throws Exception {
        ...
        updatedDepartment
                ...
                .deptIntrodution(UPDATED_DEPT_INTRODUTION)
                .deptImage(UPDATED_DEPT_IMAGE)
                .deptImageContentType(UPDATED_DEPT_IMAGE_CONTENT_TYPE);
        ...
        assertThat(testDepartment.getDeptIntrodution()).isEqualTo(UPDATED_DEPT_INTRODUTION);
        assertThat(testDepartment.getDeptImage()).isEqualTo(UPDATED_DEPT_IMAGE);
        assertThat(testDepartment.getDeptImageContentType()).isEqualTo(UPDATED_DEPT_IMAGE_CONTENT_TYPE);
